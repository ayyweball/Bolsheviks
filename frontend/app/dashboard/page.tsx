      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto">
        ...
        <main className="flex-1 p-6 space-y-6">
            ...
            <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200 text-amber-900 text-xs flex items-center justify-between shadow-sm">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-amber-800">Complete your location in your profile to view district-specific MSME market intelligence, ML classification, and microclimate signals.</p>
                </div>
              </div>
              <Link
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {/* Capital Advisory & Structuring Card (Authentic Statutory Context) */}
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between">
              <div>
                ...
                <div className="text-xs font-medium text-slate-500">Capital Advisory</div>
                <div className="text-xl font-black text-slate-900 mt-1">
              ...
              <div className="text-[11px] text-slate-400 mt-2 pt-2 border-t border-slate-100 flex items-center justify-between">
                ...
                <Link href="/advisory/financial" className="text-blue-600 hover:underline font-semibold flex items-center gap-0.5">
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div className="w-9 h-9 rounded-xl bg-purple-100 text-purple-700 flex items-center justify-center">
                    {weather?.current ? (
                      (weather.current.precipitation_mm > 0 || weather.current.weather_code >= 50) ? (
                        <CloudRain className="w-5 h-5 text-purple-700" />
                      ) : (
                        <CloudSun className="w-5 h-5 text-purple-700" />
                      )
                    ) : (
                  ...
                  <span className={`px-2.5 py-1 rounded-full text-[11px] font-bold ${
                    weather?.current
                      ? (weather.is_stale ? 'bg-amber-100 text-amber-800' : 'bg-purple-100 text-purple-800')

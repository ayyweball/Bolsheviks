    ...
    return (
      <div className="min-h-screen bg-slate-100 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-slate-500 gap-3">
          ...
          <span className="text-sm font-semibold text-slate-700">Synthesizing Official Detailed Project Report (DPR)...</span>
          <span className="text-xs text-slate-400">Grounded in 785-district census, scikit-learn ML & statutory rules</span>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-slate-100 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8">
          <div className="bg-white p-8 rounded-3xl border border-red-200 text-center max-w-md shadow-sm space-y-3">
            <AlertTriangle className="w-10 h-10 text-red-500 mx-auto" />
            <h2 className="text-base font-bold text-slate-900">Failed to Load Detailed Project Report</h2>
            <p className="text-xs text-slate-500">{error || 'Unable to retrieve canonical DPR data.'}</p>
            <button
              onClick={loadDPRData}
    ...
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans text-slate-900 antialiased">
      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto">
        ...
        <main className="flex-1 p-4 md:p-6 lg:p-8 space-y-6 w-full max-w-5xl mx-auto">
          ...
          {/* ------------------------------------------------------------- */}
          <div className="print:hidden flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
            <div className="text-xs text-slate-500">
              <span className="text-slate-400">Advisory / Business Plan / </span>
              <span className="font-mono font-bold text-slate-800">{dpr.report_id}</span>
            </div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl border border-slate-200 hover:bg-slate-50 text-slate-700 text-xs font-semibold flex items-center gap-1.5 transition disabled:opacity-50"
              >
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs font-semibold flex items-center gap-1.5 transition shadow-sm"
              >
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold flex items-center gap-1.5 transition shadow-sm disabled:opacity-50"
              >
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-bold flex items-center gap-1.5 transition shadow-sm"
              >
          ...
          <div className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 border-b border-slate-100 pb-6">
              <div className="space-y-1.5">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-50 text-emerald-800 rounded-full text-[10px] font-bold uppercase tracking-wider border border-emerald-200">
                  <ShieldCheck className="w-3.5 h-3.5 text-emerald-600" />
                  <span>Official Detailed Project Report (DPR) • Bank & Ministry Ready</span>
                </div>
                <h1 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight capitalize">
                  {dpr.project_name}
                </h1>
                <p className="text-xs text-slate-500">
                  Promoter: <span className="font-semibold text-slate-800">{dpr.promoter_name}</span> • Sector:{' '}
                  <span className="font-semibold text-slate-800">{dpr.business_type}</span>{' '}
                  {dpr.sub_type && <span className="text-slate-400">({dpr.sub_type})</span>} • Location:{' '}
              ...
              <div className="bg-slate-50 p-3 rounded-2xl border text-right shrink-0">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Report Authority</span>
                <div className="text-xs font-extrabold text-slate-900 mt-0.5">UnnatE Advisory System</div>
                <div className="text-[10px] font-mono text-slate-500">{dpr.report_id}</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
              ...
              <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-200 flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-[10px] font-bold text-slate-400 uppercase">MRI Score</span>
                    <ProvenanceBadge tag="MODELLED INDICATOR" />
                  </div>
                  <div className="text-xl font-black text-slate-900">
                    {ma.market_research_indicator.toFixed(1)} <span className="text-xs text-slate-400 font-normal">/ 100</span>
                  </div>
                </div>
                <div className="text-[10px] text-slate-500 mt-2">40% Nat • 30% State • 30% SME</div>
              </div>
              ...
              <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-200 flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-[10px] font-bold text-slate-400 uppercase">ML Archetype</span>
                    <ProvenanceBadge tag="MODELLED INDICATOR" />
                  </div>
                ...
                <div className="text-[10px] text-slate-500 mt-2">KMeans (k=4) fitted</div>
              </div>
              ...
              <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-200 flex flex-col justify-between">
                <div>
                  ...
                  <div className="text-xs font-black text-indigo-950 truncate" title={gs.program_name}>
                    {gs.program_code}
                  </div>
                </div>
                <div className="text-[10px] text-slate-500 mt-2 truncate">{gs.program_name}</div>
              </div>
              ...
              <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-200 flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-[10px] font-bold text-slate-400 uppercase">Project Cost</span>
                ...
                <div className="text-[10px] text-slate-500 mt-2">Formulation Budget</div>
              </div>

              {/* KPI 5: Net Effective Debt */}
              <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-200 flex flex-col justify-between col-span-2 md:col-span-1">
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-[10px] font-bold text-slate-400 uppercase">Net Debt</span>
          ...
          {/* ------------------------------------------------------------- */}
          <div className="print:hidden sticky top-2 z-30 bg-white/95 backdrop-blur-md p-2 rounded-2xl border border-slate-200 shadow-sm overflow-x-auto">
            <div className="flex items-center gap-1.5 min-w-max text-xs font-semibold">
              <span className="text-[10px] uppercase font-bold text-slate-400 px-2">Jump to:</span>
              {NAV_SECTIONS.map((sec) => (
                <button
                  key={sec.id}
                  onClick={() => scrollTo(sec.id)}
                  className="px-2.5 py-1 rounded-lg text-slate-600 hover:text-emerald-700 hover:bg-emerald-50 transition-colors text-[11px]"
                >
                  {sec.label}
                </button>
              ))}
          ...
          {/* ============================================================= */}
          <section id="sec-exec" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
          ...
          {/* ============================================================= */}
          <section id="sec-model" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  2
          ...
          {/* ============================================================= */}
          <section id="sec-market" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  3
          ...
          {/* ============================================================= */}
          <section id="sec-customers" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  4
          ...
          {/* ============================================================= */}
          <section id="sec-competition" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  5
          ...
          {/* ============================================================= */}
          <section id="sec-location" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  6
          ...
          {/* ============================================================= */}
          <section id="sec-operations" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  7
          ...
          {/* ============================================================= */}
          <section id="sec-marketing" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  8
          ...
          {/* ============================================================= */}
          <section id="sec-govt" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  9
          ...
          {/* ============================================================= */}
          <section id="sec-capital" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  10
          ...
          {/* ============================================================= */}
          <section id="sec-financials" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  11
                  ...
                  <div className="h-48 w-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={amortizationChartData} margin={{ top: 10, right: 20, left: 10, bottom: 0 }}>
                        ...
                        <Bar dataKey="principal" name="Principal Paid" fill="#2563eb" stackId="a" radius={[0, 0, 4, 4]} />
                        <Bar dataKey="interest" name="Interest Paid" fill="#f59e0b" stackId="a" radius={[4, 4, 0, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </div>
          ...
          {/* ============================================================= */}
          <section id="sec-risks" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  12
          ...
          {/* ============================================================= */}
          <section id="sec-implementation" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  13
          ...
          {/* ============================================================= */}
          <section id="sec-assumptions" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
          ...
          {/* ============================================================= */}
          <section id="sec-gaps" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  15
          ...
          {/* ============================================================= */}
          <section id="sec-provenance" className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center font-bold text-xs">
                  16
